...
**Say it:** "`new Function` compiles from a string in the global scope with no closure capture — which is exactly why CSP blocks it and Hermes can't run it."
