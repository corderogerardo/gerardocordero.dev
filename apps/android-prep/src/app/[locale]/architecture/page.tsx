...
export const metadata: Metadata = {
  title: "Architecture",
  description:
    "A senior-level tour of mobile system design mapped onto modern Android — Compose, MVVM/MVI, Clean Architecture, offline-first — plus concept/example/problem/solution deep-dives.",
};
