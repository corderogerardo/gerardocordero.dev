...
const STATS = [
  { value: "200+", label: "Q&A flashcards" },
  { value: "17", label: "Practice prompts" },
  { value: "34", label: "Study-guide topics" },
    ...
    <div className="animate-fade-up space-y-12">
      <section className="space-y-5">
        ...
        <p className="max-w-2xl text-lg text-muted">
          Rehearse your pitches, drill Kotlin and Jetpack Compose Q&amp;A as
          flashcards, test yourself with a quiz, and master every requirement a
          senior or staff Android role asks for — coroutines, Flow, Compose,
