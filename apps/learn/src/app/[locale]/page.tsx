  ...
  return (
    <div className="course-picker">
      ...
      <div className="course-grid">
        ...
        <CourseCard
          href="/reactnative"
          title={es ? "Práctica RN (senior)" : "RN Interview Practice"}
          emoji="🧠"
          meta={es ? "Flashcards + retos de código" : "Flashcards + coding challenges"}
          courseId="native"
        />
        ...
        {specs.map((s) => (
          <CourseCard
            ...
            title={`${s.title} ${es ? "(práctica)" : "Practice"}`}
            emoji={s.emoji}
            meta={es ? "Baraja de entrevista" : "Interview deck"}
          />
        ))}
      </div>
