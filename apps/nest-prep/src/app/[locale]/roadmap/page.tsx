  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        title={locale === "es" ? "Hoja de Ruta del Ingeniero Backend" : "Backend Engineer Roadmap"}
        lead={locale === "es"
          ? "Un camino de aprendizaje graduado por nivel a través de todo lo de esta guía. Cada etapa lista lo que ya puedes hacer y qué aprender a continuación — y cada tarjeta está etiquetada con su nivel para que puedas practicar exactamente donde estás."
