  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        lead={locale === "es"
          ? "El bucle de 20 minutos, ensamblado para ti: las tarjetas que la repetición espaciada dice que estás a punto de olvidar, más un prompt de código y uno de diseño de sistemas. Termínalo cada día y mantén la racha viva."
