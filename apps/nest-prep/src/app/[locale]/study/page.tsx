...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return locale === "es"
    ? { title: "Guía de Estudio", description: "Cada requisito de un rol senior de NestJS / Node.js, explicado a profundidad senior — con una línea de “cómo decirlo” para responder con confianza." }
