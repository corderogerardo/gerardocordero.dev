...
export const prepConfig: PrepConfig = {
  ...
  brand: {
    ...
    footerTextEs:
      "Prep senior de NestJS + Node.js · guía de estudio. Léela, practícala, dila en voz alta, repite.",
  },
  ai: {
    systemPrompt:
    ...
    placeholderEs: "Pregunta lo que sea sobre entrevistas de NestJS o Node.js…",
  },
  nav: NAV,
};
