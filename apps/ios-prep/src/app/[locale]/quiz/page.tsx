...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return locale === "es"
    ? { title: "Quiz", description: "Un quiz de opción múltiple de iOS con retroalimentación instantánea y explicada. Tus respuestas se guardan en este navegador." }
    : { title: "Quiz", description: "A multiple-choice iOS quiz with instant, explained feedback. Your answers are saved in this browser so you can finish later." };
}
