...
export const NAV: NavItem[] = [
  {
    ...
    blurbEs: "Empieza aquí — cómo usar esta guía.",
  },
  {
    href: "/today",
    label: "Today",
  ...
  },
  {
    ...
    blurbEs: "Junior → mid → senior → arquitecto. Sabe dónde estás y qué sigue.",
  },
  {
    href: "/study",
    label: "Study Guide",
    ...
    blurbEs: "Cada requisito senior de Next.js, explicado — App Router, RSC y caché.",
  },
  {
    href: "/architecture",
    label: "Architecture",
    ...
    blurbEs:
      "Inmersiones de diseño de sistemas frontend, de la estrategia de renderizado a las CDN.",
  },
  {
    href: "/pitches",
    label: "Pitches",
    ...
    blurbEs: "Presentaciones e historias STAR ensayadas para decir en voz alta.",
  },
  {
    href: "/flashcards",
    label: "Flashcards",
