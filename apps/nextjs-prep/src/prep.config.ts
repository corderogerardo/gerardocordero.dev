...
export const prepConfig: PrepConfig = {
  ...
  brand: {
    ...
    footerTextEs:
      "Prep senior de Next.js + React · guía de estudio. Léela, practícala, dila en voz alta, repite.",
  },
  ai: {
    systemPrompt:
    ...
    placeholderEs: "Pregunta lo que sea sobre entrevistas de Next.js o React…",
  },
  nav: NAV,
};
