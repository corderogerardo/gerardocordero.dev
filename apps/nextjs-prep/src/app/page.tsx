...
const STATS = [
  { value: "59", label: "Q&A flashcards" },
  { value: "11", label: "Practice prompts" },
  { value: "20", label: "Study-guide topics" },
    ...
    <div className="animate-fade-up space-y-12">
      <section className="space-y-5">
        ...
        <p className="max-w-2xl text-lg text-muted">
          ...
          rehearse spoken answers, and master every requirement a senior Next.js /
          React role asks for — the App Router, Server Components, rendering &amp;
          caching, and the architecture behind it all.
        </p>
