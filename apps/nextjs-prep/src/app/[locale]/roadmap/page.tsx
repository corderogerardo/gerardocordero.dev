...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return locale === "es"
    ? { title: "Hoja de Ruta", description: "Un camino de aprendizaje de Next.js / React graduado por nivel — junior, mid, senior, arquitecto y más allá — con lo que puedes hacer en cada nivel y qué aprender después." }
