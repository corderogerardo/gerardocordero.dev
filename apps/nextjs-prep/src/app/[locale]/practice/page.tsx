...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return locale === "es"
    ? { title: "Práctica", description: "Resolución activa de problemas: prompts de código de Next.js / React estilo entrevista y prompts de diseño de sistemas frontend, con pistas progresivas y revelado autoevaluado." }
